        ...
        setContent {
            MoviesAppTheme {
                MainScreen(onItemClick = { item ->
                    val intent = Intent(this, DetailMoveiActivity::class.java)
...
fun MainContent(onItemClick: (FilmItemModel) -> Unit) {
    ...
    var showAppComingLoading by remember { mutableStateOf(true) }
