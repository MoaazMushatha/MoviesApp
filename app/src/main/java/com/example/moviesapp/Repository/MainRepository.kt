...
class MainRepository {
    ...
    fun loadUpcoming(): LiveData<MutableList<FilmItemModel>> { //LiveData is data live and change
        ...
        ref.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(snapshot: DataSnapshot) { //snapshot is data
    ...
    fun loadItems(): LiveData<MutableList<FilmItemModel>> { //LiveData is data live and change
